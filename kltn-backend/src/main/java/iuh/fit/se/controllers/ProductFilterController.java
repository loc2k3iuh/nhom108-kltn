...
@Tag(
    name = "Product Advanced Filtering",
    description = "APIs for advanced product filtering and search")
public class ProductFilterController {
  ...
  public APIResponse<Page<ProductDetailResponse>> getProductsByRootCategory(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getProductsByRootCategory(
  ...
  public APIResponse<Page<ProductDetailResponse>> getProductsBySubCategory(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getProductsBySubCategory(
            categoryId, page, size, sortBy, sortDirection);
  ...
  public APIResponse<Page<ProductDetailResponse>> getProductsByBrand(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getProductsByBrand(brandId, additionalFilters);
  ...
  public APIResponse<Page<ProductDetailResponse>> getProductsBySize(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getProductsBySize(sizeId, additionalFilters);
  ...
  public APIResponse<Page<ProductDetailResponse>> getProductsByColor(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getProductsByColor(colorId, additionalFilters);
  ...
  public APIResponse<Page<ProductDetailResponse>> getProductsWithDiscount(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getProductsWithDiscount(
            minDiscountPercent, maxDiscountPercent, page, size, sortBy, sortDirection);
  ...
  public APIResponse<Page<ProductDetailResponse>> getFavoriteProducts(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getFavoriteProducts(userId, page, size, sortBy, sortDirection);
  ...
  public APIResponse<Page<ProductDetailResponse>> getProductsByPriceRange(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getProductsByPriceRange(
  ...
  public APIResponse<Long> countProductsByFilter(
      @Valid @RequestBody ProductFilterRequest filterRequest) {
  ...
  public APIResponse<ProductStatisticsResponse> getProductStatisticsByFilter(
    ...
    ProductStatisticsResponse response =
        productFilterService.getProductStatisticsByFilter(filterRequest);
  ...
  public APIResponse<Page<ProductDetailResponse>> getNewProducts(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.getNewProducts(page, size, sortBy, sortDirection);
  ...
  public APIResponse<Page<ProductDetailResponse>> getBestSellerProducts(
    ...
    Page<ProductDetailResponse> response = productFilterService.getBestSellerProducts(page, size);
  ...
  public APIResponse<Page<ProductDetailResponse>> searchProductsAdvanced(
    ...
    Page<ProductDetailResponse> response =
        productFilterService.searchProductsAdvanced(keyword, additionalFilters);
