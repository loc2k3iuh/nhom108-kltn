        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-[#C92127] to-[#a71b20] p-8 flex flex-col justify-between text-white">
          <div>
            ...
            <p className="text-white/80 mb-8">
              Đăng nhập để truy cập tài khoản của bạn và khám phá thế giới thời
              trang cùng với DAVINCI. Chúng tôi luôn cập nhật những sản phẩm
              thời trang mới nhất và phong cách nhất.
            </p>
          </div>
