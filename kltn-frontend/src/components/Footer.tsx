            ...
            <div className="w-full container mx-auto lg:max-w-7xl p-6 lg:p-10">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/profile" className="text-gray-600 hover:text-red-600 transition duration-200">Tài khoản của tôi</Link></li>
                            <li><Link to="/orders" className="text-gray-600 hover:text-red-600 transition duration-200">Đơn hàng</Link></li>
